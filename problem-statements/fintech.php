    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-lg-10 mx-auto text-center">
                <h1 class="header-title">Fintech</h1>
                <p class="header-subtitle">AI-powered financial inclusion for Pakistan's unbanked</p>
        ...
        <div class="row">
            <div class="col-lg-11 mx-auto">
                ...
                <div class="p-4 mb-4" style="background: rgba(255, 255, 255, 0.1); border-left: 4px solid var(--accent-color); border-radius: 0 8px 8px 0;">
                    <p class="lead">Millions remain unbanked; credit scoring and fraud prevention are underdeveloped.</p>
                </div>
                    ...
                    <div class="commercialization-content">
                        ...
                        <div class="commercialization-product">
                            ...
                            <div class="product-details">
                                <h4 class="product-name">RoshanAI Finance</h4>
                                <p class="product-description">AI-powered alternative credit scoring, fraud detection, and microfinance platform for financial inclusion</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <ul>
                    <li>AI-based credit scoring using telco/mobile wallet data</li>
                    <li>Fraud detection for digital payments</li>
                    <li>Financial planning chatbot</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Technical Requirements</h3>
                <ul>
                    <li>ML credit model AUC ≥ 0.8</li>
                    <li>Real-time fraud detection latency ≤ 2s</li>
                    <li>Urdu chatbot</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Evaluation Criteria</h3>
                <ul>
                    <li>Credit scoring precision (30%)</li>
                    <li>Fraud detection recall ≥ 85% (30%)</li>
                    <li>Chatbot usability (20%)</li>
                    <li>Documentation (20%)</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Why It's Relevant (Pakistan-specific)</h3>
                <ul>
                    <li>Financial inclusion is a top priority under Vision 2025 and SBP's Financial Inclusion Strategy</li>
                    <li>Digital lending and wallets can unlock credit access for underserved citizens</li>
                    <li>Voice-first tools can aid low-literacy populations, particularly women and the elderly</li>
                </ul>
            </div>
        </div>
    </div>
...
<style>
    ...
    .theme-header {
        ...
        height: 100vh;
        min-height: 600px;
        background: url('../assets/images/fintech.png') no-repeat center center;
