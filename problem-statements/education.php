    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-lg-10 mx-auto text-center">
                ...
                <p class="header-subtitle">AI-powered personalized learning for Pakistani students</p>
        ...
        <div class="row">
            <div class="col-lg-11 mx-auto">
                ...
                <div class="p-4 mb-4" style="background: rgba(255, 255, 255, 0.1); border-left: 4px solid var(--accent-color); border-radius: 0 8px 8px 0;">
                    <p class="lead">Students lack personalized learning, teachers lack analytics, and education content is outdated.</p>
                </div>
                    ...
                    <div class="commercialization-content">
                        ...
                        <div class="commercialization-product">
                            ...
                            <div class="product-details">
                                <h4 class="product-name">TaleemAI</h4>
                                <p class="product-description">Personalized adaptive learning + teacher support system in Urdu/regional languages, with analytics and accessibility features</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <ul>
                    <li>Adaptive math learning app (grades 6–8)</li>
                    <li>Urdu/local language translation for lessons</li>
                    <li>AI student performance analytics</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Technical Requirements</h3>
                <ul>
                    <li>Recommendation system ≥ 80% accuracy</li>
                    <li>Urdu content NLP accuracy ≥ 75%</li>
                    <li>Dashboard for teachers</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Evaluation Criteria</h3>
                <ul>
                    <li>Adaptivity of learning paths (30%)</li>
                    <li>Translation quality (25%)</li>
                    <li>Analytics clarity (25%)</li>
                    <li>User experience (20%)</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Why It's Relevant (Pakistan-specific)</h3>
                <ul>
                    <li>Pakistan ranks among the lowest in foundational literacy and numeracy.</li>
                    <li>AI can enable personalized education and fill teacher gaps, especially in underserved areas.</li>
                    <li>Urdu and local language inclusion is crucial for scalable education equity.</li>
                </ul>
            </div>
        </div>
    </div>
