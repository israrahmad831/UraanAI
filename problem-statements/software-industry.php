    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-lg-10 mx-auto text-center">
                <h1 class="header-title">Software Industry</h1>
                <p class="header-subtitle">Localized AI tools for code quality and developer productivity</p>
        ...
        <div class="row">
            <div class="col-lg-11 mx-auto">
                ...
                <div class="p-4 mb-4" style="background: rgba(255, 255, 255, 0.1); border-left: 4px solid var(--accent-color); border-radius: 0 8px 8px 0;">
                    <p class="lead">Pakistan’s software houses suffer from poor code quality, weak documentation, and lack of security tools.</p>
                </div>
                    ...
                    <div class="commercialization-content">
                        ...
                        <div class="commercialization-product">
                            ...
                            <div class="product-details">
                                <h4 class="product-name">CodeAI Pakistan</h4>
                                <p class="product-description">An AI-driven IDE plugin + SaaS platform for code quality, bug detection, and security auditing</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <ul>
                    <li>AI code review tool (Python/Java)</li>
                    <li>Automated bug detection & test generator</li>
                    <li>AI-powered code documentation generator</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Technical Requirements</h3>
                <ul>
                    <li>Code quality scoring ≥ 80% precision</li>
                    <li>Automated bug test coverage ≥ 70%</li>
                    <li>API-based doc generator</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Evaluation Criteria</h3>
                <ul>
                    <li>Code review precision (30%)</li>
                    <li>Test generator reliability (25%)</li>
                ...
                <ul>
                    <li>Enhancing software quality will help scale exports and foreign contracts</li>
                    <li>Localized tools (supporting Urdu, local standards) will aid early-career developers and SMEs</li>
                    <li>Bridges the gap between education and real-world developer workflows</li>
                </ul>
            </div>
        </div>
    </div>
...
<style>
    ...
    .theme-header {
        ...
        height: 100vh;
        min-height: 600px;
        background: url('../assets/images/software.png') no-repeat center center;
