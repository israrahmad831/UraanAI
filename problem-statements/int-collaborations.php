    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-lg-10 mx-auto text-center">
                <h1 class="header-title">International Collaborations</h1>
                <p class="header-subtitle">Strengthening Pakistan's Global AI Presence</p>
        ...
        <div class="row">
            <div class="col-lg-11 mx-auto">
                ...
                <div class="p-4 mb-4" style="background: rgba(255, 255, 255, 0.1); border-left: 4px solid var(--accent-color); border-radius: 0 8px 8px 0;">
                    <p class="lead">Pakistan lacks AI standards, datasets, and global compliance frameworks.</p>
                </div>
                    ...
                    <div class="commercialization-content">
                        ...
                        <div class="commercialization-product">
                            ...
                            <div class="product-details">
                                <h4 class="product-name">PakAI Global Exchange</h4>
                                <p class="product-description">AI-powered international collaboration and ethics compliance portal for cross-border research and data sharing</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <ul>
                    <li>Develop standardized open datasets (Urdu + English)</li>
                    <li>AI ethics compliance checklist</li>
                    <li>Collaboration portal prototype</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Technical Requirements</h3>
                <ul>
                    <li>Dataset format aligned with global standards</li>
                    <li>Compliance checklist mapped to OECD/EU</li>
                    <li>Portal MVP (accounts + data sharing)</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Evaluation Criteria</h3>
                <ul>
                    <li>Dataset reusability (30%)</li>
                    <li>Ethics compliance clarity (30%)</li>
                    <li>Portal functionality (20%)</li>
                    <li>Documentation (20%)</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Why It's Relevant (Pakistan-specific)</h3>
                <ul>
                    <li>Building global trust and visibility boosts soft power, funding access, and exports</li>
                    <li>Sharing high-quality, local datasets (e.g., agriculture, biodiversity, health) supports SDG-linked research</li>
                    <li>Aligning with international ethical frameworks improves interoperability and scalability</li>
                </ul>
            </div>
        </div>
    </div>
...
<style>
    ...
    .theme-header {
        ...
        height: 100vh;
        min-height: 600px;
        background: url('../assets/images/collaborations.jpg') no-repeat center center;
