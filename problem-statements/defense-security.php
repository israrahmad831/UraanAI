    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-lg-10 mx-auto text-center">
                <h1 class="header-title">Defense / Strategic Organizations</h1>
                <p class="header-subtitle">AI Solutions for National Security and Strategic Defense</p>
        ...
        <div class="row">
            <div class="col-lg-11 mx-auto">
                ...
                <div class="p-4 mb-4" style="background: rgba(255, 255, 255, 0.1); border-left: 4px solid var(--accent-color); border-radius: 0 8px 8px 0;">
                    <p class="lead">Pakistan requires AI-powered surveillance, cyber defense, and border security systems.</p>
                </div>
                    ...
                    <div class="commercialization-content">
                        ...
                        <div class="commercialization-product">
                            ...
                            <div class="product-details">
                                <h4 class="product-name">SurakhshaAI</h4>
                                <p class="product-description">Integrated AI defense toolkit for cyber threat intelligence, border surveillance, and secure communications</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <ul>
                    <li>Threat intelligence AI</li>
                    <li>Video surveillance analytics</li>
                    <li>Border anomaly detection</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Technical Requirements</h3>
                <ul>
                    <li>Threat model precision ≥ 80%</li>
                    <li>CV for surveillance accuracy ≥ 85%</li>
                    <li>Border anomaly prototypes</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Evaluation Criteria</h3>
                <ul>
                    <li>Threat detection accuracy (30%)</li>
                    <li>Video analytics (25%)</li>
                    <li>Border anomaly recall (25%)</li>
                    <li>Documentation (20%)</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Why It's Relevant (Pakistan-specific)</h3>
                <ul>
                    <li>National security requires real-time situational awareness and readiness.</li>
                    <li>Reducing reliance on foreign surveillance tools preserves data sovereignty and operational secrecy.</li>
                    <li>Early threat detection systems can prevent cross-border smuggling, terrorism, and internal sabotage.</li>
                </ul>
            </div>
        </div>
    </div>
...
<style>
    ...
    .theme-header {
        ...
        height: 100vh;
        min-height: 600px;
        background: url('../assets/images/defence.png') no-repeat center center;
