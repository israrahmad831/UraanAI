    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-lg-10 mx-auto text-center">
                <h1 class="header-title">AI Infrastructure</h1>
                <p class="header-subtitle">Building Pakistan's National AI Infrastructure</p>
        ...
        <div class="row">
            <div class="col-lg-11 mx-auto">
                ...
                <div class="p-4 mb-4" style="background: rgba(255, 255, 255, 0.1); border-left: 4px solid var(--accent-color); border-radius: 0 8px 8px 0;">
                    <p class="lead">Pakistan lacks a unified AI infrastructure with localized support for Urdu/regional languages, government data standards, and reliable compute resources.</p>
                </div>
                    ...
                    <div class="commercialization-content">
                        ...
                        <div class="commercialization-product">
                            ...
                            <div class="product-details">
                                <h4 class="product-name">Pakistan National AI Cloud & API Gateway</h4>
                                <p class="product-description">A shared compute + API infrastructure for government, academia, startups</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <ul>
                    <li>Design a common data schema for government datasets</li>
                    <li>Build NLP models for Urdu text classification</li>
                    <li>Create secure API layer for small data exchange</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Technical Requirements</h3>
                <ul>
                    <li>Submit schema design (JSON/XML format) covering at least 3 government datasets (health, education, population)</li>
                    <li>Train an Urdu NLP model (classification or sentiment analysis) using an open-source dataset</li>
                    <li>Implement RESTful APIs with authentication and rate-limiting</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Evaluation Criteria</h3>
                <ul>
                    <li>Completeness and reusability of data schema (20%)</li>
                    <li>Accuracy of Urdu NLP model ≥ 80% (30%)</li>
                    <li>Security and functionality of API (20%)</li>
                    <li>Documentation and code quality (30%)</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Why It's Relevant (Pakistan-specific)</h3>
                <ul>
                    <li>Critical for building national capacity in AI and ensuring digital independence</li>
                    <li>Supports implementation of the Pakistan Digital Authority Act and National AI Policy</li>
                    <li>Enables local researchers, startups, and public sector innovators to build and deploy AI solutions confidently</li>
                </ul>
            </div>
        </div>
    </div>
...
<style>
    ...
    .theme-header {
        ...
        height: 100vh;
        min-height: 600px;
        background: url('../assets/images/foundation.jpg') no-repeat center center;
