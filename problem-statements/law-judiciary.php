    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-lg-10 mx-auto text-center">
                <h1 class="header-title">Law and Judiciary</h1>
                <p class="header-subtitle">AI-powered Solutions for Pakistan’s Justice System</p>
        ...
        <div class="row">
            <div class="col-lg-11 mx-auto">
                ...
                <div class="p-4 mb-4" style="background: rgba(255, 255, 255, 0.1); border-left: 4px solid var(--accent-color); border-radius: 0 8px 8px 0;">
                    <p class="lead">Massive backlog, lack of digital case management, and poor access to legal data.</p>
                </div>
                ...
                <div class="commercialization-card mb-5">
                    ...
                    <div class="commercialization-content">
                        ...
                        <p class="commercialization-text">
                            If the winner team solves all the problems in Phase 1 (Online 1 Month), 
                            Phase 2 (Techathon Day) and Phase 3 (Incubation + Mentorship only for Winners), 
                            what product or service will it actually become at the commercialization stage?
                        </p>
                        <div class="commercialization-product">
                            ...
                            <div class="product-details">
                                <h4 class="product-name">AdalAI</h4>
                                <p class="product-description">
                                    An AI-based legal case management system with automated case tagging, 
                                    legal search, prioritization, and document summarization.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <ul>
                    <li>Case classification AI.</li>
                    <li>Legal precedent search tool.</li>
                    <li>Case prioritization model.</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Technical Requirements</h3>
                <ul>
                    <li>Classification accuracy ≥ 80%.</li>
                    <li>Precedent retrieval engine.</li>
                    <li>ML case ranking tool.</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Evaluation Criteria</h3>
                <ul>
                    <li>Classification precision (30%)</li>
                    <li>Retrieval accuracy (25%)</li>
                    <li>Case ranking clarity (25%)</li>
                    <li>Documentation (20%)</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Why It's Relevant (Pakistan-specific)</h3>
                <ul>
                    <li>Access to timely justice is a constitutional right.</li>
                    <li>AI-powered legal tools can optimize workflows, reduce bottlenecks, and assist under-resourced courts.</li>
                    <li>Enables better case management, especially for low-income litigants and public defenders.</li>
                </ul>
            </div>
        </div>
    </div>
...
<style>
    ...
    .theme-header {
        ...
        height: 100vh;
        min-height: 600px;
        background: url('../assets/images/law.png') no-repeat center center;
    ...
    @media (max-width: 768px) {
        .theme-header { min-height: 500px; height: 80vh; }
        .header-title { font-size: 2.5rem; }
        .header-subtitle { font-size: 1.1rem; }
        .section-title { font-size: 1.8rem; }
        .commercialization-card { flex-direction: column; text-align: center; }
        .commercialization-icon { margin-right: 0; margin-bottom: 15px; }
        .commercialization-product { flex-direction: column; text-align: center; }
        .product-icon { margin-right: 0; margin-bottom: 10px; }
    }
