    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-lg-10 mx-auto text-center">
                <h1 class="header-title">Manufacturing Industry</h1>
                <p class="header-subtitle">AI solutions for quality control and predictive maintenance</p>
        ...
        <div class="row">
            <div class="col-lg-11 mx-auto">
                ...
                <div class="p-4 mb-4" style="background: rgba(255, 255, 255, 0.1); border-left: 4px solid var(--accent-color); border-radius: 0 8px 8px 0;">
                    <p class="lead">Pakistani industries face high wastage, low automation, and frequent equipment failures.</p>
                </div>
                    ...
                    <div class="commercialization-content">
                        ...
                        <div class="commercialization-product">
                            ...
                            <div class="product-details">
                                <h4 class="product-name">PakIndustry 4.0 AI Suite</h4>
                                <p class="product-description">A toolkit for defect detection, predictive maintenance, workflow automation, and worker safety monitoring</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <ul>
                    <li>Computer vision defect detection (e.g., textile defects)</li>
                    <li>Predictive maintenance using IoT sensor data</li>
                    <li>AI-driven supply chain forecasting</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Technical Requirements</h3>
                <ul>
                    <li>Train defect detection CV model with >85% accuracy</li>
                    <li>Predictive maintenance ML model with IoT dummy data</li>
                    <li>Forecast inventory needs using ARIMA/LSTM</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Evaluation Criteria</h3>
                <ul>
                    <li>Defect detection accuracy ≥ 85% (30%)</li>
                    <li>Maintenance prediction reliability ≥ 80% (25%)</li>
                    <li>Supply chain forecast error ≤ 10% (25%)</li>
                ...
                <ul>
                    <li>Export-oriented manufacturing loses billions annually due to production defects</li>
                    <li>Majority of Pakistan's industrial units are mid-sized, locally managed, and not AI-aware</li>
                    <li>Enhancing quality and reliability is essential for international competitiveness</li>
                </ul>
            </div>
        </div>
    </div>
...
<style>
    ...
    .theme-header {
        ...
        height: 100vh;
        min-height: 600px;
        background: url('../assets/images/manufacturing.png') no-repeat center center;
