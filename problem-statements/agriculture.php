    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-lg-10 mx-auto text-center">
                <h1 class="header-title">Agriculture</h1>
                <p class="header-subtitle">AI-powered solutions for smallholder farmers</p>
        ...
        <div class="row">
            <div class="col-lg-11 mx-auto">
                ...
                <div class="p-4 mb-4" style="background: rgba(255, 255, 255, 0.1); border-left: 4px solid var(--accent-color); border-radius: 0 8px 8px 0;">
                    <p class="lead">Pakistan's farmers face huge losses due to pests, climate shocks, and lack of AI-driven predictive support.</p>
                </div>
                    ...
                    <div class="commercialization-content">
                        ...
                        <div class="commercialization-product">
                            ...
                            <div class="product-details">
                                <h4 class="product-name">KisanAI Advisor</h4>
                                <p class="product-description">Mobile-based AI service for farmers (disease detection, irrigation alerts, market intelligence)</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <ul>
                    <li>Mobile app for crop disease detection (image-based)</li>
                    <li>Weather-linked irrigation alert system</li>
                    <li>Crop yield forecasting for wheat/rice</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Technical Requirements</h3>
                <ul>
                    <li>Train CV model for pest/disease detection using crop image datasets</li>
                    <li>Link app with weather API for irrigation scheduling</li>
                    <li>Develop regression/ML model for yield forecasting</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Evaluation Criteria</h3>
                <ul>
                    <li>Disease detection accuracy ≥ 80% (30%)</li>
                    <li>Timeliness & accuracy of irrigation alerts (25%)</li>
                    <li>Yield prediction error ≤ 10% (25%)</li>
                    <li>Documentation & usability of app (20%)</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Why It's Relevant (Pakistan-specific)</h3>
                <ul>
                    <li>Agriculture supports over 38% of the workforce and ensures national food security.</li>
                    <li>80% of farmers are smallholders who cannot afford expensive agri-advisory tools.</li>
                    <li>Real-time alerts can prevent yield loss, reduce pesticide misuse, and improve incomes.</li>
                </ul>
...
<style>
    ...
    .theme-header {
        ...
        height: 100vh;
        min-height: 600px;
        background: url('../assets/images/agriculture.png') no-repeat center center;
