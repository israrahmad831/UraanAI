    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-lg-10 mx-auto text-center">
                <h1 class="header-title">Energy & Climate Change</h1>
                <p class="header-subtitle">AI Solutions for Sustainable Energy and Climate Resilience</p>
        ...
        <div class="row">
            <div class="col-lg-11 mx-auto">
                ...
                <div class="p-4 mb-4" style="background: rgba(255, 255, 255, 0.1); border-left: 4px solid var(--accent-color); border-radius: 0 8px 8px 0;">
                    <p class="lead">Energy shortfalls and climate disasters are worsening in Pakistan.</p>
                </div>
                    ...
                    <div class="commercialization-content">
                        ...
                        <div class="commercialization-product">
                            ...
                            <div class="product-details">
                                <h4 class="product-name">PakEnergyAI</h4>
                                <p class="product-description">AI platform for electricity demand forecasting, renewable optimization, disaster early warning, and carbon tracking</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <ul>
                    ...
                    <li>Solar/wind energy integration optimizer</li>
                    <li>AI for carbon tracking</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Technical Requirements</h3>
                <ul>
                    <li>Forecasting RMSE ≤ 10%</li>
                    <li>Renewable optimizer ≥ 80% accuracy</li>
                    <li>Carbon dashboard</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Evaluation Criteria</h3>
                <ul>
                    <li>Forecast accuracy (30%)</li>
                    <li>Renewable integration gains (25%)</li>
                    <li>Dashboard clarity (25%)</li>
                    <li>Documentation (20%)</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Why It's Relevant (Pakistan-specific)</h3>
                <ul>
                    <li>Smart energy forecasting ensures efficient generation and reduced outages</li>
                    <li>AI-driven alerts for floods or droughts help mitigate disasters and economic losses</li>
                    <li>Early warning systems are vital for protecting agriculture, housing, and infrastructure</li>
                </ul>
            </div>
        </div>
    </div>
...
<style>
    ...
    .theme-header {
        ...
        height: 100vh;
        min-height: 600px;
        background: url('../assets/images/energy.png') no-repeat center center;
