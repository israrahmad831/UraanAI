    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center">
            <div class="col-lg-10 mx-auto text-center">
                ...
                <p class="header-subtitle">AI-powered oversight for public spending and service delivery</p>
        ...
        <div class="row">
            <div class="col-lg-11 mx-auto">
                ...
                <div class="p-4 mb-4" style="background: rgba(255, 255, 255, 0.1); border-left: 4px solid var(--accent-color); border-radius: 0 8px 8px 0;">
                    <p class="lead">Weak monitoring of public procurement, corruption, and slow citizen services hamper governance effectiveness.</p>
                </div>
                    ...
                    <div class="commercialization-content">
                        ...
                        <div class="commercialization-product">
                            ...
                            <div class="product-details">
                                <h4 class="product-name">GovAI Transparency Portal</h4>
                                <p class="product-description">An AI-driven national platform for procurement monitoring, citizen chatbots, budget transparency</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <ul>
                    <li>AI-based anomaly detection in procurement data</li>
                    <li>Citizen service chatbot for two federal services (utility bills, CNIC verification)</li>
                    <li>Budget visualization dashboard</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Technical Requirements</h3>
                <ul>
                    <li>Train anomaly detection model using synthetic procurement dataset</li>
                    <li>Develop chatbot with multilingual (English/Urdu) interface</li>
                    <li>Build interactive dashboard using Power BI/Tableau/Plotly</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Evaluation Criteria</h3>
                <ul>
                    <li>Fraud detection accuracy ≥ 85% (30%)</li>
                    <li>Chatbot usability and language support (30%)</li>
                    <li>Dashboard visualization clarity and interactivity (20%)</li>
                    <li>Documentation & reproducibility (20%)</li>
                </ul>
                
                <h3 class="mt-5 mb-3" style="color: var(--primary-color);">Why It's Relevant (Pakistan-specific)</h3>
                <ul>
                    <li>Tackling corruption and inefficiency is a Vision 2025 and Governance Innovation priority</li>
                    <li>Enables data-informed decision-making in government departments</li>
                    <li>Aligns with E-Governance and Open Government aspirations of MoPDSI</li>
                </ul>
            </div>
        </div>
    </div>
...
<style>
    ...
    .theme-header {
        ...
        height: 100vh;
        min-height: 600px;
        background: url('../assets/images/governance-banner.jpg') no-repeat center center;
